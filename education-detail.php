...
<!-- Education Sec Start Here -->
<section class="eductaion_sec pad-10">
            ...
            <div class="col-lg-2">
                <div class="recent-post">
                    ...
                    <div class="post-dv">
                        ...
                        <div class="txt">
                            <h4>Lorem Ipsum</h4>
                            <p class="admin"><i class="fa fa-user" aria-hidden="true"></i> By admin</p>
                ...
                <div class="post-detail">
                    ...
                    <div class="content-wrapper">
                        ...
                        <div class="share-option">
                            <p><i class="fa fa-tag" aria-hidden="true"></i> John Doe</p>
