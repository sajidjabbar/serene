                        ...
                        <div class="input-group">
                            ...
                            <button class="btn">
                                <svg xmlns="http://www.w3.org/2000/svg" width="21.566" height="21.566" viewBox="0 0 21.566 21.566">
                                    <path id="magnifiying-glass" d="M21.321,20.135l-5.263-5.263a9.09,9.09,0,1,0-1.186,1.186l5.263,5.263a.838.838,0,1,0,1.186-1.186ZM1.677,9.077a7.4,7.4,0,1,1,7.4,7.4A7.408,7.408,0,0,1,1.677,9.077Z" />
                                </svg>
                            </button>
                        </div>
                    </form>
