    ...
    <div class="container-fluid p-0">
        <div class="row">
            <div class="col-lg-2 p-0">
                <div class="category-box wow animate__animated animate__fadeInLeft">
                    <h4 class="title">All Catagories</h4>
                    <ul class="categories">
                        <li><a href="#">SHINE ON by 7K, <i class="fa fa-angle-right" aria-hidden="true"></i></a></li>
                        <li><a href="#">Jeweled - Handmade <i class="fa fa-angle-right" aria-hidden="true"></i></a></li>
                        <li><a href="#">Drilled Earring Pairs <i class="fa fa-angle-right" aria-hidden="true"></i></a>
                        </li>
                        <li><a href="#">gogo <i class="fa fa-angle-right" aria-hidden="true"></i></a></li>
                        <li><a href="#">La Preciada <i class="fa fa-angle-right" aria-hidden="true"></i></a></li>
                        <li><a href="#">HIM Jewels, <i class="fa fa-angle-right" aria-hidden="true"></i></a></li>
                        <li><a href="#">African Green Opal <i class="fa fa-angle-right" aria-hidden="true"></i></a></li>
                        <li><a href="#">Beads Collection <i class="fa fa-angle-right" aria-hidden="true"></i></a></li>
                        <li><a href="#">Gemstones Collection <i class="fa fa-angle-right" aria-hidden="true"></i></a>
                        </li>
                        <li><a href="#">Beadnic<i class="fa fa-angle-right" aria-hidden="true"></i></a></li>
                        <li><a href="#">Rough and Slabs<i class="fa fa-angle-right" aria-hidden="true"></i></a></li>
                        <li><a href="#">Gemstones and Cabochons.<i class="fa fa-angle-right" aria-hidden="true"></i></a>
                        </li>
                    </ul>
                </div>
            </div>
            <div class="col-lg-10 p-0">
                <div class="banner_slider">
                    <div class="slides">
                        ...
                        <div class="slide-text">
                            <div class="inner-text">
                                <h1 class="wow animate__animated animate__fadeInDown">Original and best quality<br />
                                    Gems and Jewelry in<br />
                                    lowest price</h1>
                                <div class="button-group wow animate__animated animate__fadeInDown animate__delay-1s">
                                    <a href="shop.php" class="sloth-btn">Shop
                                        Now</a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="slides">
                        ...
                        <div class="slide-text">
                            <div class="inner-text">
                                <h3 class="wow animate__animated animate__fadeInDown animate__delay-1s">Best Prices for
                                    you</h3>
                                <h1 class="wow animate__animated animate__fadeInDown animate__delay-2s">Discover The
                                    best
                                    Jewelry</h1>
                                <div class="button-group wow animate__animated animate__fadeInDown animate__delay-3s">
                    ...
                    <div class="slides">
                        ...
                        <div class="slide-text">
                            <div class="inner-text">
                                <h3 class="wow animate__animated animate__fadeInDown animate__delay-1s">Best Prices for
                                    you</h3>
                                <h1 class="wow animate__animated animate__fadeInDown animate__delay-2s">Natural Beads
                                    & Jewellery</h1>
                                <div class="button-group wow animate__animated animate__fadeInDown animate__delay-3s">
                                    <a href="shop.php" class="sloth-btn">Shop Now</a>
                                </div>
        ...
        <div class="offer-stripe">
            <h4>"Free shipping on orders over $35 within the US" </h4>
        </div>
    </div>
</section>
<!-- Banner Sec End Here -->
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-3 col-md-6">
                <div class="cat-box dark-box wow animate__animated animate__bounceIn">
                    <div class="cat-img">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="cat-box dark-box wow animate__animated animate__bounceIn animate__delay-1s">
                    <div class="cat-img">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="cat-box lght-box wow animate__animated animate__bounceIn animate__delay-2s">
                    <div class="cat-img">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="cat-box lght-box wow animate__animated animate__bounceIn animate__delay-3s">
                    <div class="cat-img">
...
<!-- New Arrival Sec Start Here -->
<section class="new-arrival pad-10">
    <div class="container-fluid">
        <div class="title-wrapper wow animate__animated animate__fadeInDown">
            <h2>New Arrival</h2>
        </div>
        <div class="row">
            <div class="col-lg-3 col-md-4">
                <div class="product-box wow animate__animated animate__fadeIn">
                    <a href="product-detail.php">
                        ...
                        <div class="pro-text">
                            ...
                            <h5 class="name">Lorem Ipsum is simply dummy</h5>
                        </div>
                    </a>
                </div>
            </div>
            <div class="col-lg-3 col-md-4">
                <div class="product-box wow animate__animated animate__fadeIn animate__delay-1s">
                    <a href="product-detail.php">
                        <div class="pro-mg">
            ...
            <div class="col-lg-3 col-md-4">
                <div class="product-box wow animate__animated animate__fadeIn animate__delay-2s">
                    <a href="product-detail.php">
                        <div class="pro-mg">
            ...
            <div class="col-lg-3 col-md-4">
                <div class="product-box wow animate__animated animate__fadeIn animate__delay-3s">
                    <a href="product-detail.php">
                        <div class="pro-mg">
...
<!-- New Arrival Sec End Here -->

<!-- Off Sec Start Here -->
<section class="off_sec">
    <div class="container">
            ...
            <div class="row align-items-center">
                <div class="col-lg-8">
                    <div class="content-wrapper">
                        <div class="off-boxes">
                            <h5 class="wow animate__animated animate__fadeInLeft">End of the year sale</h5>
                            <h2 class="wow animate__animated animate__fadeInLeft animate__delay-1s">Serene Sloth Jewelry
                                & Beads
                                70% OFF</h2>
                            <h5 class="wow animate__animated animate__fadeInLeft animate__delay-2s">Now Upto 70% Off
                                Today</h5>
                            <div class="button-group wow animate__animated animate__fadeInLeft animate__delay-3s">
                ...
                <div class="col-lg-4">
                    <div class="lady-img wow animate__animated animate__fadeInRight">
                        <figure><img src="img/lady.webp" alt="123" class="img-fluid"></figure>
                    </div>
                </div>
            </div>
        </div>
...
<!-- Artist Sec Start Here -->
<section class="atrist pad-10">
    <div class="container-fluid">
        <div class="row align-items-center">
            <div class="col-lg-5">
                <div class="content-wrapper">
                    <div class="title">
                        <h2 class="wow animate__animated animate__fadeInLeft">World Class<br /> Artists</h2>
                    </div>
                    <p class="black wow animate__animated animate__fadeInLeft animate__delay-1s">
                        Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                        Vestibulum tempus euismod viverra. Donec luctus dolor tellus,
                        eget congue magna aliquet id. Etiam vulputate libero eget
                        quam blandit fermentum.
                    </p>
                    <p class="green wow animate__animated animate__fadeInLeft animate__delay-2s">
                        Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                        Vestibulum tempus euismod viverra. Donec luctus dolor tellus,
                        eget congue magna aliquet id. Etiam vulputate libero eget
                    </p>
        ...
        <div class="row">
            ...
            <div class="col-lg-9 p-0">
                <div class="product-main-box">
                    <div class="title">
                        <h2>Wide Range Of Natural Beads</h2>
                    </div>
                    <div class="row align-items-center">
                        <div class="col-lg-3 col-md-6">
                            <div class="product-box wow animate__animated animate__bounceIn">
                                <a href="#">
                                    <div class="pro-mg">
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="product-box wow animate__animated animate__bounceIn animate__delay-1s">
                                <a href="#">
                                    <div class="pro-mg">
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="product-box wow animate__animated animate__bounceIn animate__delay-2s">
                                <a href="#">
                                    <div class="pro-mg">
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="product-box wow animate__animated animate__bounceIn animate__delay-3s">
                                <a href="#">
                                    <div class="pro-mg">
    ...
    <div class="container-fluid p-0">
        <div class="row align-items-center">
            <div class="col-lg-5">
                <div class="content-wrapper">
                    <div class="title">
                        <h4 class="wow animate__animated animate__fadeInLeft">About Our Stone</h4>
                        <h2 class="wow animate__animated animate__fadeInLeft animate__delay-1s">About Our Jewelry
                            &<br />
                            Stone Beads</h2>
                    </div>
                    <p class="wow animate__animated animate__fadeInLeft animate__delay-2s">
                        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum tempus euismod viverra.
                        Donec luctus dolor tellus, eget congue magna aliquet id. Etiam vulputate libero eget quam
                        blandit fermentum.Etiam vulputate libero eget quam blandit fermentum.<br /><br />
                        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum tempus euismod viverra
                    </p>
                    <div class="button-group wow animate__animated animate__fadeInLeft animate__delay-3s">
                        <a href="#" class="sloth-btn">Read more</a>
